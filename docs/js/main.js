...
window.addEventListener('DOMContentLoaded', () => {
  ...
  resizableSwiper('(max-width: 900px)', '.benefits__slider', {
    freemode: true,
    spaceBetween: 20,
    slidesPerView: 'auto'
  }
  ...
  resizableSwiper('(max-width: 576px)', '.prod__slider', {
    freemode: true,
    spaceBetween: 20,
    slidesPerView: 'auto'
  }
...
if (document.querySelector('.modal form')) {
  (0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.modal form', rules1, checks, afterForm);
}
